...
var AtomTsd = (function () {
    ...
    AtomTsd.prototype.reinstall = function () {
        ...
        if (answer === 0) {
            ...
            this.outView.clean();
            this.outView.show();
            var waitMessage = cycleMessage('reinstalling', function (msg) {
    ...
    AtomTsd.prototype.update = function () {
        ...
        if (answer === 0) {
            ...
            this.outView.clean();
            this.outView.show();
            var waitMessage = cycleMessage('updating', function (msg) {
                _this.outView.setStatus(msg);
            });
            Tsd.update(function (line) {
                if (line != '--finish--') {
    ...
    AtomTsd.prototype.install = function () {
        ...
        this.atomTsdView = new AtomTsdView(this._items, function (def) {
            ...
            if (answer === 0) {
                ...
                _this.outView.clean();
                _this.outView.show();
                var waitMessage = cycleMessage('installing', function (msg) {
                    _this.outView.setStatus(msg);
                });
